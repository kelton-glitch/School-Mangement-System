                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            <div class="icon bg-danger-light rounded w-60 h-60">
                                <i class="text-dark mr-0 font-size-24 mdi mdi-book"></i>
                            </div>
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Number Of Subjects</p>
                                <h3 class="text-white mb-0 font-weight-500">{{ $subjects }} </h3>
                            </div>
                        </div>
                    </div>
                </div>
